  ...
  const rightPart = (
    <React.Fragment>
      ...
      <RightPartComponent
        ...
        buttons={[
          { text: "Selecting a country", url: `/${DISEASE_STH_ROUNDWORM}` },
        ]}
      />
      ...
      <RightPartComponent
        ...
        buttons={[
          { text: "Modelling paper", url: `/${DISEASE_STH_ROUNDWORM}` },
          { text: "Model code on github", url: `/${DISEASE_STH_ROUNDWORM}` },
        ]}
      />
      ...
      <RightPartComponent
        ...
        buttons={[
          { text: "Help us improve", url: `/${DISEASE_STH_ROUNDWORM}` },
          { text: "Report a problem", url: `/${DISEASE_STH_ROUNDWORM}` },
        ]}
      />
