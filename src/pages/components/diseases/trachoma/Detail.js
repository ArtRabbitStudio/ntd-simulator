  ...
  const rightPart = (
    <React.Fragment>
      ...
      <RightPartComponent
        ...
        buttons={[
          { text: "Selecting a country", url: `/${DISEASE_TRACHOMA}` },
        ]}
      />
      ...
      <RightPartComponent
        ...
        buttons={[
          { text: "Modelling paper", url: `/${DISEASE_TRACHOMA}` },
          { text: "Model code on github", url: `/${DISEASE_TRACHOMA}` },
        ]}
      />
      ...
      <RightPartComponent
        ...
        buttons={[
          { text: "Help us improve", url: `/${DISEASE_TRACHOMA}` },
          { text: "Report a problem", url: `/${DISEASE_TRACHOMA}` },
        ]}
      />
